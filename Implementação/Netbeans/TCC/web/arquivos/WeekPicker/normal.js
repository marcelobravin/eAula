...
var gsOutOfRange="Data de nascimento inválida";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hoje : "+gToday[2]+" de "+gMonths[gToday[1]-1]+" de "+gToday[0]+"</A>";	// the content of the bottom section.
