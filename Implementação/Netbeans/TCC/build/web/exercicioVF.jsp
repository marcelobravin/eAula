<%-- 
    Document   : exercicioVF
    Created on : 14/12/2011, 17:37:38
    Author     : Mark
--%>
    ...
    <body>
        <div class="body">
            ...
            <div id="conteudo">
                ...
                <center>
                    <h2>Exercício - Verdadeiro \ Falso</h2>
                    <form name="cadastro" action="ControleExercicio" method="post" class="conteiner">
                        ...
                        <input type="text" value="Marque a resposta verdadeira" id="pergunta" name="pergunta">
			...
			<ol type="a">
                            <li>
                                <input type="text" value="Alternativa1" name="alternativa[]" onClick="this.select()">
                                <input type="radio" value="1" name="resposta" class="obrigatorio">
                            </li>

                            <li>
                                <input type="text" value="Alternativa2" name="alternativa[]" onClick="this.select()">
                                <input type="radio" value="2" name="resposta" class="obrigatorio">
                            </li>
			</ol>
			

                        <!-- Fim do formulario -->
                        <input type="submit" name="inserirVF" value="Criar exercício" />
